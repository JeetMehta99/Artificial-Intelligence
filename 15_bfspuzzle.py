...
#Defines state 
class board:
    def __init__(self, size, curr_state,time):
        self.size = size
    ...
    def from_string(stt):
        try:
            ...
            return stt(size, curr_state, time)
...
if __name__ == "__main__":
    ...
    path, explorednodes, total_time, memory_required = puzzle.bfs_exec()
    print("Moves = {}".format([n.action for n in path]))
    print("Total Nodes expanded={} ".format(explorednodes))
